...
class CerDoc extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('cer_no, doc_id, vend_id, cer_date, cer_oper_date, cer_name, cer_ct_name, cer_di_name, cer_notes, cer_status, cer_date_add', 'required'),
			array('doc_id, vend_id, cer_status', 'numerical', 'integerOnly'=>true),
			array('cer_no', 'length', 'max'=>20),
			array('cer_name, cer_ct_name, cer_di_name, cer_notes', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('cer_id, cer_no, doc_id, vend_id, cer_date, cer_oper_date, cer_name, cer_ct_name, cer_di_name, cer_notes, cer_status, cer_date_add', 'safe', 'on'=>'search'),
		);
	}
