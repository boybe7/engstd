...
<div class="row-fluid">
	...
	<div class="span6">
		<?php echo CHtml::textField('newprodtype', '',array('class'=>'span12','placeholder'=>'กรอกชื่อชนิดท่อและอุปกรณ์')); ?>
	</div>
...
$this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
        ...
        'prot_code'=>array(
			    ...
			    'filter'=>CHtml::activeTextField($model, 'prot_code',array("placeholder"=>"ค้นหาตาม".$model->getAttributeLabel("prot_code"))),
		...
		'prot_name'=>array(
			    'name' => 'prot_name',
			    'class' => 'editable.EditableColumn',
			    'filter'=>CHtml::activeTextField($model, 'prot_name',array("placeholder"=>"ค้นหาตาม".$model->getAttributeLabel("prot_name"))),
