...
<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
  ...
  echo "<input type='hidden' id='old_cer_no' value='".$model->cer_no."'>";
	...
	<div class="row-fluid">
		<div class="span3">
         ...
         if(Yii::app()->user->isExecutive() || Yii::app()->user->isAdmin())
           echo $form->textFieldRow($model,'cer_no',array('class'=>'span12','maxlength'=>20, 'disabled' =>true)); 
         else 
           echo $form->textFieldRow($model,'cer_no',array('class'=>'span12','maxlength'=>20, 'disabled' =>true)); 
	...
	<?php 
						 ...
						 echo '<div class="input-append" style="margin-top:-10px;">'; //ใส่ icon ลงไป
		                    ...
		                    array(
		                        ...
		                        'htmlOptions'=>array('class'=>'span12', 'value'=>$model->cer_oper_date, 'disabled' =>true),  // ใส่ค่าเดิม ในเหตุการ Update 
		                     )
		                );
		                echo '<span class="add-on"><i class="icon-calendar"></i></span></div>';
	...
	<?php 
                        ...
                        echo $form->dropDownListRow($model, 'cer_name', $typelist,array('class'=>'span12','prompt'=>'--กรุณาเลือก--', 'disabled' =>true)); 
    ...
    $models=User::model()->with(array(
                        ...
                        $typelist = CHtml::listData($data,'value','text');
                        echo $form->dropDownListRow($model, 'cer_ct_name', $typelist,array('class'=>'span12','prompt'=>'--กรุณาเลือก--', 'disabled' =>true)); 
	...
	<?php 
                        ...
                        $typelist = CHtml::listData($data,'value','text');
                        echo $form->dropDownListRow($model, 'cer_di_name', $typelist,array('class'=>'span12','prompt'=>'--กรุณาเลือก--', 'disabled' =>true)); 
    ...
    <div class="row-fluid">
        <div class="span12"> 
	       <?php echo $form->textAreaRow($model,'cer_notes',array('class'=>'span12','rows'=>4,'wrap'=>"physical", 'disabled' =>true)); ?>
        </div>
    </div>
