<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#con_id,#con_id2,#cust_id,#cust_id2,#prot_id,#prot_id2").autocomplete({
        ...
        //--------คู่สัญญาทั้งหมด------------
        $('#contractor_all').click(function() {
            if($('#contractor_all') .attr( 'checked' ) )
            {
        ...
        //--------เลขที่สัญญาทั้งหมด------------
        $('#con_id_all').click(function() {
            if($('#con_id_all') .attr( 'checked' ) )
            {
                $("#con_id").prop('disabled', true);
                $("#con_id2").prop('disabled', true);
            }
            else
            {
				
                $("#con_id").prop('disabled', false);
                $("#con_id2").prop('disabled', false);
            }
        });
...
<div class="well">
    ...
    <div class="row-fluid">
        <div class="span3">
            ...
            echo '<input type="checkbox" id="contractor_all" name="mm" value="mm">';
            echo '</label>';
            ?>
        </div>
        <div class="span3">
...
?>
    ...
    <div class="row-fluid">
        ...
        <div class="span3">
<?php
            echo CHtml::label('เลขที่สัญญาทั้งหมด', 'workcat');
            echo '<label class="checkbox span5">';
            echo '<input type="checkbox" id="con_id_all" name="mm" value="mm">';
            echo '</label>';
?>
        </div>
        <div class="span3">
            ...
            <?php
            echo CHtml::label('เลขที่สัญญาเริ่มต้น', 'workcat');
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'con_id',
                'id' => 'con_id',
                //'value'=>$model->con_id,
        ...
        <div class="span3">
            <?php
            echo CHtml::label('เลขที่สัญญาสิ้นสุด', 'workcat');
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                'name' => 'con_id2',
                'id' => 'con_id2',
                //'value'=>$model->con_id,
