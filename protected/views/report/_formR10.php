...
?>
  ...
  <table class="table">
     <thead>
      <tr>
        <th style="text-align:center">ผู้ตรวจโรงงาน</th>
        <th style="text-align:center">ใบรับรอง</th>
        <th style="text-align:center">วันดำเนินการ</th>
        <th style="text-align:center">วัน/ใบรับรอง</th>
      </tr>
    </thead>
    <tbody>
          <?php
