...
//-------------------------------
	...
	class MYPDF extends TCPDF {
		    ...
		    public function Header() {
		        ...
		        $this->writeHTMLCell(145, 20, 40, 10, '55555รายงานสรุปยอดรับรองท่อ/อุปกรณ์<br>การประปานครหลวง', 0, 1, false, true, 'C', false);
...
//----------------------------------
	    ...
	    $html .= 'xxxxxx999เงื่อนไขรายงาน&nbsp;:&nbsp;วันดำเนินการจาก&nbsp;'.$date_st.'&nbsp;ถึง&nbsp;'.$date_en.'<br><br>';

	    $html .= '<table>';
	    $html .= '<thead>';
	    $html .= '  <tr style="line-height: 40px;backg" bgcolor="#f5f5f5">';
	    $html .= '    <th style="font-size:18px;font-weight:bold;border:1px solid black;text-align:center;width:25%">8888รหัสท่อ/อุปกรณ์</th>';
